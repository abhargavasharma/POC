...
{
    public class LetMePlayTALDefaultPlanSelectionAndConfiguration : BasePlanSelectionAndConfigurationService
    {
        ...
        public LetMePlayTALDefaultPlanSelectionAndConfiguration(IPlanService planService, ICoverService coverService,
        ...
        public override void SetupSelections(IRisk risk, IEnumerable<IPlan> plans, IEnumerable<ICover> covers, IEnumerable<IOption> options)
        {
            ...
            var ciCoverAmount = GetCoverAmountBasedOnRules(risk, ciPlan, 100000);
