window.visitor = Visitor.getInstance("7A0DBB1A56CC37127F000101@AdobeOrg", {
  trackingServer:"talservices.sc.omtrdc.net",
  trackingServerSecure:"talservices.sc.omtrdc.net",  
});
window.visitor.cookieDomain = "tal.com.au";

window.s = new AppMeasurement();
window.s.visitor = window.visitor;
...
s.linkInternalFilters="javascript:,tal.com.au" + window.location.hostname;
...
s.visitorNamespace="talservices";
s.trackingServer="talservices.sc.omtrdc.net";
...
if(!s.campaign)s.contextData["ecid"]=s.campaign=s.Util.getQueryParam('ecid');
...
if(!s.contextData["icid"])
  s.contextData["icid"]=s.Util.getQueryParam('icid');
s.contextData["icid"]=s.getValOnce(s.contextData["icid"],'s_icid',0);

if (s.Util.getQueryParam('ecid'))  s.contextData["ext_campaign"] = s.Util.getQueryParam('ecid'); //external campaign code
...
//s.contextData["t_week"] = s.getTimeParting('w', '11');
...
s.contextData["url_path"] = window.location.pathname;
...
window.digitalData.page.pageInfo.pageName = capitalize_Words(window.digitalData.page.pageInfo.pageName);
window.digitalData.page.pageInfo.pageName = rmwh(window.digitalData.page.pageInfo.pageName);  
};

if (window.digitalData.page.category.primaryCategory) {
window.digitalData.page.category.primaryCategory = capitalize_Words(window.digitalData.page.category.primaryCategory);
window.digitalData.page.category.primaryCategory = rmwh(window.digitalData.page.category.primaryCategory);  
};

if (window.digitalData.page.category.subCategory1) {
window.digitalData.page.category.subCategory1 = capitalize_Words(window.digitalData.page.category.subCategory1);
window.digitalData.page.category.subCategory1 = rmwh(window.digitalData.page.category.subCategory1);  
};

if (window.digitalData.page.category.subCategory2) {
window.digitalData.page.category.subCategory2 = capitalize_Words(window.digitalData.page.category.subCategory2);
window.digitalData.page.category.subCategory2 = rmwh(window.digitalData.page.category.subCategory2);
};
...
s.eventLoop = function() {
    ...
    if (!s.triggered && typeof digitalData != "undefined") {
        ...
        if (typeof digitalData != "undefined" && digitalData.events && digitalData.events.length != 0) {
            ...
            digitalData.events.forEach(function(evt) {
                loadProcess(evt);
            });
        }
