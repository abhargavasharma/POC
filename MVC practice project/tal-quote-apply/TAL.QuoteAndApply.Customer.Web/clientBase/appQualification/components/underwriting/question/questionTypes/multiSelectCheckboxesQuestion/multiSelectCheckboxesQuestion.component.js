(function (module) {
    'use strict';
    module.directive('talMultiSelectCheckboxesQuestion', function () {
        return {
            templateUrl: '/client/appQualification/components/underwriting/question/questionTypes/multiSelectCheckboxesQuestion/multiSelectCheckboxesQuestion.template.html',
            restrict: 'E',
            scope: {
                question: '=',
                onQuestionAnswered: '&'
            ...
            controllerAs: 'ctrl',
            controller: 'talMultiSelectCheckboxesQuestionController'
        };
    });

    function talMultiSelectCheckboxesQuestionController(talUnderwritingService) {
        var ctrl = this;
    ...
    module.controller('talMultiSelectCheckboxesQuestionController', talMultiSelectCheckboxesQuestionController);
    talMultiSelectCheckboxesQuestionController.$inject = ['talUnderwritingService'];
