...
{
    [TestFixture]
    public class LifePlanCoverAmountServiceTests
    {
        ...
        [Test]
        public void GetMinCover_LifePlanMinCoverAmount_Is100000()
        {
            //Arrange //Act
            var minCover = _coverAmountService.GetMinCover("DTH", "tal");
        ...
        [TestCase(59)]
        [TestCase(60)]
        public void GetMaxCover_ToAge64Range_IncomeMultipledByIncomeFactorLessThanUnrestrictedMaxCover_MaximumUnrestrictedCoverReturned(int age)
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 10000, 100000, null));
        ...
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 100000, 100000, null));
        ...
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 50000, 100000, null));
        ...
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 200000, 100000, null));
        ...
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 120000, 100000, null));
            Assert.That(maxCover, Is.EqualTo(600000));
        }

        [TestCase(60)]
        [TestCase(64)]
        public void GetMaxCover_60to64AgeRange_IncomeMultipledByIncomeFactorAboveMaxCover_MaxCoverReturned(int age)
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 200000, 100000, null));
            Assert.That(maxCover, Is.EqualTo(500000));
        }
        ...
        [TestCase(60)]
        [TestCase(64)]
        public void GetMaxCover_60to64AgeRange_IncomeMultipledByIncomeFactorLessThanMaxCover_MaxCoverReturned(int age)
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 120000, 100000, null));
            Assert.That(maxCover, Is.EqualTo(500000));
        }
        ...
        [TestCase(65)]
        [TestCase(74)]
        public void GetMaxCover_65to74AgeRange_IncomeMultipledByIncomeFactorAboveMaxCover_MaxCoverReturned(int age)
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 200000, 100000, null));
            Assert.That(maxCover, Is.EqualTo(250000));
        }

        [TestCase(65)]
        [TestCase(74)]
        public void GetMaxCover_65to74AgeRange_IncomeMultipledByIncomeFactorLessThanMaxCover_MaxCoverReturned(int age)
        {
            var maxCover = _coverAmountService.GetMaxCover(new MaxCoverAmountParam("DTH", "tal", age, 40000, 100000, null));
            Assert.That(maxCover, Is.EqualTo(250000));
        }
    }
}
